                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-xl-4">
                    ...
                    <div class="product-item">
                      <div class="product-thumb">
                        <a href="shop-single-product.html">
                          <img src="assets/img/shop/12.png" alt="Alan-Shop">
                          <div class="ribbons">
                            <span class="ribbon ribbon-hot">Sale</span>
                      ...
                      <div class="product-info">
                        <h4 class="title"><a href="shop-single-product.html">10. This is the large tit...</a></h4>
                        <div class="prices">
                  ...
                  <div class="col-md-6 col-xl-4">
                    ...
                    <div class="product-item">
                      <div class="product-thumb">
                        <a href="shop-single-product.html">
                          <img src="assets/img/shop/20.png" alt="Alan-Shop">
                        </a>
                        <div class="product-action">
                          <a class="action-wishlist" href="shop-wishlist.html" title="Wishlist">
                            <i class="ion-android-favorite-outline"></i>
                      ...
                      <div class="product-info">
                        <h4 class="title"><a href="shop-single-product.html">5. Simple product</a></h4>
                        <div class="prices">
                  ...
                  <div class="col-md-6 col-xl-4">
                    ...
                    <div class="product-item">
                      <div class="product-thumb">
                        <a href="shop-single-product.html">
                          <img src="assets/img/shop/21.png" alt="Alan-Shop">
                          <div class="ribbons">
                            <span class="ribbon ribbon-hot">Sale</span>
                      ...
                      <div class="product-info">
                        <h4 class="title"><a href="shop-single-product.html">6. Variable with soldout ...</a></h4>
                        <div class="prices">
                          <span class="price">$55.00</span>
                          <del class="price-old">$75.00</del>
                        </div>
                      </div>
                    </div>
                    <!-- End Product Item -->
                  ...
                  <div class="col-md-6 col-xl-4">
                    ...
                    <div class="product-item">
                      <div class="product-thumb">
                        <a href="shop-single-product.html">
                          <img src="assets/img/shop/19.png" alt="Alan-Shop">
                        </a>
                        <div class="product-action">
                          <a class="action-wishlist" href="shop-wishlist.html" title="Wishlist">
                            <i class="ion-android-favorite-outline"></i>
                  ...
                  <div class="col-md-6 col-xl-4">
                    ...
                    <div class="product-item">
                      <div class="product-thumb">
                        <a href="shop-single-product.html">
                          <img src="assets/img/shop/11.png" alt="Alan-Shop">
                        </a>
                        <div class="product-action">
                          <a class="action-wishlist" href="shop-wishlist.html" title="Wishlist">
                            <i class="ion-android-favorite-outline"></i>
                  ...
                  <div class="col-md-6 col-xl-4">
                    ...
                    <div class="product-item">
                      <div class="product-thumb">
                        <a href="shop-single-product.html">
                          <img src="assets/img/shop/10.png" alt="Alan-Shop">
                        </a>
                        <div class="product-action">
                          <a class="action-wishlist" href="shop-wishlist.html" title="Wishlist">
                            <i class="ion-android-favorite-outline"></i>
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="product-item product-item-list">
                      ...
                      <div class="product-info">
                        <h4 class="title"><a href="shop-single-product.html">1. New and sale badge product</a></h4>
                        <div class="prices">
                          <span class="price">$141.76</span>
                          <del class="price-old">$167.53</del>
                        </div>
                  ...
                  <div class="col-12">
                    ...
                    <div class="product-item product-item-list">
                      ...
                      <div class="product-info">
                        <h4 class="title"><a href="shop-single-product.html">10. This is the large title for testing large title and there is an image for testing</a></h4>
                        <div class="prices">
                          <span class="price">$24.49</span>
                          <del class="price-old">$27.06</del>
                        </div>
                        <p>A long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of...</p>
                        <div class="product-action">
                          <a class="action-wishlist" href="shop-wishlist.html" title="Wishlist">
                            <i class="ion-android-favorite-outline"></i>
                          </a>
                    ...
                    <div class="product-item product-item-list">
                      ...
                      <div class="product-info">
                        ...
                        <div class="prices">
                          ...
                          <del class="price-old">$109.54</del>
                        </div>
                  ...
                  <div class="col-12">
                    ...
                    <div class="product-item product-item-list">
                      ...
                      <div class="product-info">
                        <h4 class="title"><a href="shop-single-product.html">4. Soldout productt</a></h4>
                        <div class="prices">
                          <span class="price">$24.49</span>
                          <del class="price-old">$37.37</del>
                        </div>
                  ...
                  <div class="col-12">
                    ...
                    <div class="product-item product-item-list">
                      ...
                      <div class="product-info">
                        ...
                        <div class="prices">
                          <span class="price">$70.88</span>
                          <del class="price-old">$96.65</del>
                        </div>
                  ...
                  <div class="col-12">
                    ...
                    <div class="product-item product-item-list">
                      ...
                      <div class="product-info">
                        <h4 class="title"><a href="shop-single-product.html">8. Countdown product</a></h4>
                        <div class="prices">
                          <span class="price">$50.26</span>
                          <del class="price-old">$77.32</del>
                        </div>
                  ...
                  <div class="col-12">
                    ...
                    <div class="product-item product-item-list">
                      ...
                      <div class="product-info">
                        ...
                        <p>we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by...</p>
                        <div class="product-action">
                          <a class="action-wishlist" href="shop-wishlist.html" title="Wishlist">
                            <i class="ion-android-favorite-outline"></i>
                          </a>
            ...
            <div class="shop-sidebar-area">
              ...
              <div class="widget">
                ...
                <div class="widget-categories-menu">
                  <ul>
                    <li class="has-sub">
                      <a class="collapsed" data-bs-toggle="collapse" data-bs-target="#sub-menu" aria-expanded="false">Home</a>
