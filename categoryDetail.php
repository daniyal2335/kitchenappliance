...
$keywords = "website, jamal, Kitchen Products ";
...
if ($category_id > 0) {
    ...
    $stmt_category = $pdo->prepare("SELECT * FROM category WHERE id = ?");
    $stmt_category->execute([$category_id]);
    $category = $stmt_category->fetch();

    
    $stmt_products = $pdo->prepare("SELECT * FROM products WHERE c_id = ?");
    ...
    <div class="row">
      <div class="col-md-8 col-lg-6 m-auto">
        <div class="section-title text-center">
          <h2 class="title"> Products in "<?php echo htmlspecialchars($category['name']); ?>"</h2>
        </div>
      </div>
    </div>
    <div class="row">
          ...
          <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
            ...
            <div class="product-item">
              <div class="product-thumb">
                <a href="productDetail.php?id=<?= htmlspecialchars($product['id']); ?>">
