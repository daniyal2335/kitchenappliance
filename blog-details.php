...
$keywords = "website, jamal, Blog Details";
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="page-title-content text-center">
              <h2 class="title text-white">There are many variations of passages</h2>
              <div class="bread-crumbs">
                ...
                <span class="active">There are many variations of passages</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-9">
            <div class="post-details-content">
              <div class="post-details-body">
                <div class="content">
                  <div class="thumb">
                    <img src="assets/img/blog/1.webp" alt="Alan-Blog">
                  </div>
                  <h4>There are many variations of passages</h4>
                  <ul class="meta">
                    <li class="date">January 26, 2021</li>
                    <li class="author">Demo Alan Admin</li>
                  </ul>
                  ...
                  <div class="category-social-content">
                    <div class="category-items">
                      <a href="blog.html">Baller</a>
                      <a href="blog.html">Corer</a>
                      <a href="blog.html">Cups</a>
                      <a href="blog.html">Ladle</a>
                      <a href="blog.html">Ricer</a>
                      <a href="blog.html">Spatula</a>
                    </div>
                    ...
                    <div class="single-comment">
                      <div class="author-info">
                        ...
                        <div class="author-details">
                          <h4 class="name">Daniel Vandaft</h4>
                          <div class="comment-date">Jan 26, 2021 at 17:58 </div>
            ...
            <div class="sidebar-area mt-md-50">
              ...
              <div class="widget">
                ...
                <div class="widget-archive">
                  ...
                  <ul>
                    <li><a href="blog.html">There are many variations of passages</a></li>
                    <li><a href="blog.html">The standard chunk of lorem ipsum used since</a></li>
                    <li><a href="blog.html">There are many variations of passages of lorem ipsum available</a></li>
                    <li><a href="blog.html">The standard chunk of lorem ipsum used since</a></li>
                    <li><a href="blog.html">It is a long established fact that a reader will be distracted</a></li>
                    <li><a href="blog.html">There are many variations of passages of lorem ipsum available</a></li>
                    <li><a href="blog.html">The standard chunk of lorem ipsum used since</a></li>
                    <li><a href="blog.html">It is a long established fact that a reader will be distracted</a></li>
                    <li><a href="blog.html">It is a long established fact that a reader will be distracted</a></li>
